...
class Home extends React.Component {
  ...
  render() {
    ...
    <div class="container">
      ...
      <div class="media">
        <div class="media-content">
          <h1 class="title is-1 has-text-centered"> Get a Quote</h1>
          <p class="subtitle"></p>
        </div>
      </div>
      <br />
    ...
    <div class="media">
      <div class="media-content">
        <h1 class="title is-1 has-text-centered"> Become A Driver</h1>
        <p class="subtitle"></p>
      </div>
    </div>
    <br />
  ...
  <div class="media">
    <div class="media-content">
      <h1 class="title is-1 has-text-centered"> About Us</h1>
      <p class="subtitle"></p>
    </div>
  </div>
  <br />
...
<br />
<br />
    <h1 class="title is-1 has-text-centered">Our Mission Statement</h1>
    <br />
<div class="content">
  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
  Phasellus nec iaculis mauris. Phasellus nec iaculis mauris. <a>@bulmaio</a>.
